...
// Don't duplicate me!
if (!class_exists('ReduxFramework_extension_yprm_typography')) {

  /**
   * Main ReduxFramework yprm_typography extension class
   *
   * @since       3.1.6
   */
  class ReduxFramework_extension_yprm_typography {

    // Set the version number of your extension here
    public static $version = '1.0.0';

    // Set the name of your extension here
    public $ext_name = 'YPRM Typography';
    ...
    public function __construct($parent) {
      ...
      $this->field_name = 'yprm_typography';
