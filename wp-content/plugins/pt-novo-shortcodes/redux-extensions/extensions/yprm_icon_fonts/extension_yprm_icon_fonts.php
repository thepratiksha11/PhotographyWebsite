...
// Don't duplicate me!
if (!class_exists('ReduxFramework_extension_yprm_icon_fonts')) {

  /**
   * Main ReduxFramework yprm_icon_fonts extension class
   *
   * @since       3.1.6
   */
  class ReduxFramework_extension_yprm_icon_fonts {

    // Set the version number of your extension here
    public static $version = '1.0.0';

    // Set the name of your extension here
    public $ext_name = 'YPRM Icon Fonts';
    ...
    public function __construct($parent) {
      ...
      $this->field_name = 'yprm_icon_fonts';
