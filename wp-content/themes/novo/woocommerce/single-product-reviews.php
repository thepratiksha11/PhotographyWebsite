		...
		<div id="review_form_wrapper">
            ...
            'class_form'           => 'comment-form row',
					...
					if ( get_option( 'woocommerce_enable_review_rating' ) === 'yes' ) {
						$comment_form['fields']['author'] = '<div class="col-12"><p class="comment-form-rating"><label class="h6" for="rating">' . __( 'Your Rating', 'novo' ) .'</label><select name="rating" id="rating" aria-required="true" required>
						...
						</select></p></div><div class="col-12 col-sm-6">' . '<input id="author" class="style1" name="author" type="text" placeholder="'. esc_html__( 'Enter your Name...','novo' ) .'" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30" /></div>';
					}
