...
class YPRM_Admin_Pages {
  ...
  public function add_menu() {
    add_menu_page(esc_html__('Theme Dashboard', 'novo'), esc_html__('Novo Theme', 'novo'), 'manage_options', 'novo_dashboard', array($this, 'render'), 'dashicons-art', 2);
  }
      ...
      <div class="row yprm-dashicons">
        ...
        <div class="col-12 col-sm-4">
          <div class="yprm-dashicon-item">
            ...
            <a href="https://promo-theme.com/novo/docs/" target="_blank"></a>
          </div>
        </div>
        <div class="col-12 col-sm-4">
          <div class="yprm-dashicon-item">
